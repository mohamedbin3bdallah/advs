  ...
  <body>  
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title"><?php language('about'); ?></h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="main-container">
      <div class="container" dir="rtl">
        <div class="row">          
          <div class="col-sm-12">
            <img src="<?php echo $about['picture']; ?>" style="width:100%;" alt="about">
            <div class="ad-detail-content">
              <h3 style="text-align:center; margin:55px;"><?php language('vision'); ?></h3>
              <blockquote style="text-align:justify;"><p><?php echo $about['vision']; ?></p></blockquote>
              <h3 style="text-align:center; margin:55px;"><?php language('mission'); ?></h3>
              <blockquote style="text-align:justify;"><p><?php echo $about['mission']; ?></p></blockquote>
            </div>
          </div>
        </div>
      </div>
