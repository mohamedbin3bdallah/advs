		...
		<div class="col-sm-12">
			<form class="form-horizontal" action="admin.php?c=<?php echo $_GET['c']; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
				...
				<div class="form-group">
					...
					<label for="dr" class="col-sm-2 <?php if($lang == 'ar') echo 'col-sm-push-1'; ?> control-label">جنيه</label>
					<div class="col-sm-3 <?php if($lang == 'ar') echo 'col-sm-push-1'; ?>">
					...
					<label for="/" class="col-sm-1 <?php if($lang == 'ar') echo 'col-sm-pull-4'; ?> control-label">\</label>
					<label for="month" class="col-sm-1 <?php if($lang == 'ar') echo 'col-sm-pull-6'; ?> control-label"><?php language('month'); ?></label>
				</div>
				<div class="form-group">
