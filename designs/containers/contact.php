	<div class="row">	
		<div class="col-sm-8 col-sm-offset-2">
			<form class="form-horizontal" action="admin.php?c=<?php echo $_GET['c']; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
				...
				<div class="form-group">
					<label for="dribble" class="col-sm-2 <?php if($lang == 'ar') echo 'col-sm-push-10'; ?> control-label"><?php language('dribble'); ?></label>
					<div class="col-sm-10 <?php if($lang == 'ar') echo 'col-sm-pull-2'; ?>">
						<input type="text" class="form-control" name="dribble" id="dribble" value="<?php if(isset($row['dribble'])) echo $row['dribble']; ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label for="flickr" class="col-sm-2 <?php if($lang == 'ar') echo 'col-sm-push-10'; ?> control-label"><?php language('flickr'); ?></label>
					<div class="col-sm-10 <?php if($lang == 'ar') echo 'col-sm-pull-2'; ?>">
						<input type="text" class="form-control" name="flickr" id="flickr" value="<?php if(isset($row['flickr'])) echo $row['flickr']; ?>"/>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-10">
