<?php
	...
	include('develops/categories-front.php');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title">دليل الشركات</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="content">
	  ...
	  <?php if(!empty($categories)) { ?>
		...
		<?php for($cat=0;$cat<count($categories);$cat++) { ?>
          <div class="col-sm-4 col-md-4 <?php if($cat%3 == 0) echo 'col-sm-push-8 col-md-push-8'; elseif($cat%3 == 2) echo 'col-sm-pull-8 col-md-pull-8'; ?>">
            <div class="page-login-form box">
              <h3>
                <?php echo $categories[$cat]['title']; ?>
              </h3>
				<img class="img-responsive" src="uploads/categories/<?php echo $categories[$cat]['picture'];?>">
			  <p style="text-align:center; margin-top:11px;">
				<button type="button" class="btn btn-info" onclick="location.href = 'sitepages.php?keyword=&type=<?php echo $categories[$cat]['title']; ?>'"><?php language('more'); ?></button>
			  </p>
            </div>
          </div>
		  <?php } ?>
