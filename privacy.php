<?php
	...
	include('develops/privacy-front.php');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title"><?php language('privacy'); ?></h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">          
          <div class="col-sm-12">
            <div class="ad-detail-content">
              <h3 style="text-align:center; margin:55px;"><?php language('privacy'); ?></h3>
              <blockquote style="text-align:justify;"><p><?php echo $privacy['page']; ?></p></blockquote>
            </div>
          </div>
        </div>
      </div>
