<?php
	...
	include('develops/instructions-front.php');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title"><?php language('instructions'); ?></h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">          
          <div class="col-sm-12">
            <div class="ad-detail-content">
              <h3 style="text-align:center; margin:55px;"><?php language('instructions'); ?></h3>
              <blockquote style="text-align:justify;"><p><?php echo $instructions['page']; ?></p></blockquote>
            </div>
          </div>
        </div>
      </div>
