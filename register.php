        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title"><?php language('register'); ?></h2>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="page-login-form box">
			  ...
			  <p class="text-center">
				<?php
					...
					elseif(isset($_GET['message']) && $_GET['message'] == 'm6') language('m1');
				?>
			</p>
              <form role="form" class="login-form" action="#" method="post">
                ...
                <div class="form-group">
                  <div class="input-icon">
                    ...
                    <input type="text" class="form-control" name="username" id="username" pattern="[A-Za-z]{5,}" title="<?php language('m21'); ?>" maxlength="255" placeholder="<?php language('username'); ?>" autocomplete="off" required/>
                  </div>
                </div> 
				<div class="form-group">
                  <div class="input-icon">
				...
				<div class="form-group">
                  <div class="input-icon">
                    ...
                    <input type="password" class="form-control" name="password" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="<?php language('m7'); ?>" placeholder="<?php language('password'); ?>" autocomplete="off" required/>
                  </div>
                </div>
                <div class="checkbox">
                  <label for="remember">بانشاء حساب تكون قد وافقت على بنودنا وشروطنا</label><br>
				  <!--<input type="checkbox" id="remember" name="rememberme" value="forever" style="float: right;" required>-->
                </div>
                <button type="submit" class="btn btn-common log-btn" name="submit" id="submit"><?php language('register'); ?></button>
              </form>
            </div>
          </div>
        </div>
